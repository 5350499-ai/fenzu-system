...
export default function BackupShareTestPage() {
  ...
  async function shareBackupJson() {
    ...
    const file = new File([json], "same-backup.json", { type: "application/json" });
    await navigator.share({ files: [file] });
  }

  return <main><button type="button" onClick={() => void shareBackupJson()}>分享同一份 Backup JSON</button></main>;
}
