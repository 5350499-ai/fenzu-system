...
function emptyPayment(propertyId: string): BusinessRentPayment { return { id: "", propertyId, roomId: "", tenantId: "", incomeType: "房租收入", incomeItem: "", rentMonth: new Date().toISOString().slice(0, 7), amountDue: 0, amountPaid: 0, amountUnpaid: 0, paymentMethod: "转账", receivedBy: "A", isOverdue: false, notes: "" }; }
function emptyDeposit(propertyId: string): BusinessDeposit { return { id: "", propertyId, roomId: "", tenantId: "", type: "收取", amount: 0, status: "已收", transactionDate: "", receivedBy: "A", paidBy: "A", notes: "" }; }
function emptyExpense(propertyId: string): BusinessExpense { return { id: "", propertyId, expenseMonth: "2026-06", category: "房东租金", amount: 0, paymentDate: "", paidBy: "A", isPaid: true, notes: "" }; }
