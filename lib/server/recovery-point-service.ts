...
export async function recordRecoveryPoint(admin: AdminClient, payload: DataExportPayload, input: { workspaceOwnerId: string; source: RecoveryPointSource; storageBucket: string; storagePath: string; createdBy?: string | null; }) {
