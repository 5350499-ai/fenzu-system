export const ACCOUNT_MODULES = [
  ...
  { key: "check_in", label: "一键入住", actions: ["view", "create"] },
  ...
  { key: "deposits", label: "押金", actions: ["view", "create", "edit", "archive", "delete"] },
  { key: "tasks", label: "待办", actions: ["view", "create", "edit", "archive", "delete"] },
  { key: "archive", label: "档案中心", actions: ["view"] },
