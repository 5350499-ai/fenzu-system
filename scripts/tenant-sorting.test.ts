...
assert.deepEqual(sortTenantsByRoomAndStatus([tenant("active-502", "502", "欠租"), tenant("active-501", "501"), tenant("old-501", "501", "已退租", "2026-07-29"), tenant("active-503", "503")], rooms).map((item) => item.id), ["active-501", "old-501", "active-502", "active-503"]);
