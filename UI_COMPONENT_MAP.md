...
- `PasswordInput` owns the controlled password text/clear affordance across authentication, self-service and account-management fields. Pages retain their own labels, autocomplete mode and any parent-owned show/hide control.
