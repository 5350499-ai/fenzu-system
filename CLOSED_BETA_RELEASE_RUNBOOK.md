...
- Record the verified Brevo Custom SMTP sender (`Bee Rental` / `s641776255s@outlook.com`) without recording credentials. Password reset and email-confirmation E2E are verified; never revert to an unverified sender.
