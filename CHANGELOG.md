...
## 2026-08-14 - Shared responsive primitive convergence

- The shared `.grid` primitive now consumes the existing `--ui-grid-gap` token without changing its computed 16px spacing. Business-specific responsive contracts and BUG-01 ownership remain unchanged.
...
## 2026-08-02 - Controlled tenant move-out and room vacancy (Preview)
...
# 2026-08-21 - FEATURE-ZERO-AMOUNT-DEBT-AND-WAIVE-FEEDBACK (Preview)
...
## 2026-08-22 - Content-driven foundation closeout: identity and monthly results (Preview)
